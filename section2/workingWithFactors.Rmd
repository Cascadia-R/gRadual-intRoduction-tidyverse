...
We'll do this by doing a bar plot and progressively making it more complicated.
...
pets <- data.frame(id=c('C1','C2','D1','D4','D8', 'C4', "D5"),
                names=factor(c("Morris", "Morris", "Fido", "Bowser", "Fido", "Sheba", "Hubert")),
                weights=c(6,7,15,20,40, 10, 60),
                animal=factor(c("cat", "cat", "dog", "dog", "dog", "cat", "dog")),
                ##because it's an ordered category, we have to specify 
                ##order as the levels argument
                ageCategory= ordered(c("0-2", "5-8", "5-8", "3-4", "3-4", "5-8", "0-2"), 
                                       levels=c("0-2", "3-4", "5-8")),
                shotsCurrent=c("No", "Yes", NA, "No", "Yes", "No", "No"))
...
Given the `pets` `data.frame`, plot a barchart
